    ...
    <div class="col-sm-9">
        <div class="row">
            <section style="padding-left: 40px; padding-right:40px;margin-top: 50px">
                <div style="height:230px;background-color:green;text-align: center;" class="col-sm-3">
                ...
                <div style="height:230px;background-color:#FF836B;text-align: center;" class="col-sm-3">
                ...
                <div style="height:230px;background-color:#00A9F0;text-align: center;"class="col-sm-3" >
                    <div class="card card-blue" >
                        <h3>Products Sold </h3>
                        <h2 style="color: #282828; text-align: center;"><?php echo $total_sell?$total_sell['total_sell']: 'You haven\'t sold anything yet'; ?></h2>
                    </div>
                </div>
                <div style="height:230px;background-color:#FF3E3E;text-align: center"class="col-sm-3" >
            ...
            <div class="col-sm-12" style="height:500px;margin-bottom: 20px;margin-top: 20px;background-color: #010001;margin-left:55px">
                <div class="text-center">
                    <h1 style="color: #c6a109" > Edit Product</h1>
                    <h2> <?php echo $m; ?> </h2>
                </div>
                <div class="row pt-20" >
